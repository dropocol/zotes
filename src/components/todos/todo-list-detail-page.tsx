...
export function TodoListDetailPage({
  ...
  const progress =
    topLevelItems.length > 0
      ? Math.round(
          (completedItems.length / todoList.items.length) * 100,
        )
      : 0;
  ...
  return (
    <DashboardLayout breadcrumbs={breadcrumbs}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                &quot;? This will also delete all items. This action cannot
                be undone.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
      ...
      <TodoListContainer todoListId={listId} hasProject={hasProject} />
    </DashboardLayout>
  );
}
